"""
3D scaling visualization

- Translucent cube = original (unscaled) cube at origin
- Solid cube       = scaled cube using hard-coded (SX, SY, SZ)
...
def main():
    ...
    glutCreateWindow(b"3D Scaling: Original (Translucent) vs Scaled (Solid)")

    init_gl()

    print("3-D scaling (SX, SY, SZ):", (SX, SY, SZ))
