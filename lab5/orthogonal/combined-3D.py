...
def apply_combined_transform():
    """
    Effective on vertices: v' = T * Rz * Ry * Rx * Sh * S * v
    """
...
def motion(x, y):
    global rot_x, rot_y, last_x, last_y, ortho_size
    dx = x - last_x
    dy = y - last_y
...
def main():
    ...
    glutCreateWindow(b"3D Combined Transform: T + R + Shear + Scale (ORTHO)")
    ...
    print("Orthographic projection (right-drag changes ortho zoom)")
